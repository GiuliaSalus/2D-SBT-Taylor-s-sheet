...
void bsstep(double y[], double dydx[], int nv, double *xx, double htry,
	...
	void  (*derivs)(double ,double [],double [], double [],double [],double [],double [],double [],int ,int  ),double fx[],double fy[],double par[],double nodes[],double var[],int N,int NQ);
...
void mmid(double y[], double dydx[], int nvar, double xs, double htot,
	int nstep, double yout[], void (*derivs)(double ,double [],double [], double [],double [],double [],double [],double [],int ,int  ),double fx[],double fy[],double par[],double nodes[],double var[],int N,int NQ);
...
void odeint(double ystart[], int nvar, double x1, double x2, double eps, double h1,
	    double hmin, int *nok, int *nbad,double un[],double dun[],double kappa[],double xm[],double ym[],double theta[],double sm[],double dt,int NN,double par[] );
...
void rkck(double y[], double dydx[], int n, double x, double h,
	  double yout[], double yerr[],double un[],double dun[],double kappa[],double xm[],double ym[],double theta[],double sm[],double dt,int NN,double par[]);
void rkdumb(double vstart[], int nvar, double x1, double x2, int nstep,
	void (*derivs)(double, double [], double []));
void rkqs(double y[], double dydx[], int n, double *x,
	  double htry, double eps, double yscal[], double *hdid, double *hnext,double un[],double dun[],double kappa[],double xm[],double ym[],double theta[],double sm[],double dt,int NN,double par[]);
...
void zbrak(float (*fx)(float), float x1, float x2, int n, float xb1[],
	float xb2[], int *nb);
double zbrent(double (*func)(double,double *), double x1, double x2, double tol,double par[]);
